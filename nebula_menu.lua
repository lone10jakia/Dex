...
local theme = {
	...
	panel = Color3.fromRGB(32, 17, 55),
	panelDark = Color3.fromRGB(23, 12, 41),
	accent = Color3.fromRGB(251, 113, 133),
	text = Color3.fromRGB(255, 238, 245),
	muted = Color3.fromRGB(216, 173, 195),
	stroke = Color3.fromRGB(111, 66, 98),
}
...
local languageStrings = {
	vi = {
		...
		menu_title = "NEBULA CORE Menu",
		hint = "Nhấn RightShift để bật/tắt NEBULA CORE",
	...
	en = {
		...
		menu_title = "NEBULA CORE Interface",
		hint = "Press RightShift to toggle NEBULA CORE",
...
create("UIGradient", {
	Color = ColorSequence.new({
		ColorSequenceKeypoint.new(0, Color3.fromRGB(62, 27, 89)),
		ColorSequenceKeypoint.new(1, Color3.fromRGB(26, 11, 43)),
	}),
	Rotation = 140,
	Parent = main,
})
...
local rightDock = create("Frame", {
	Name = "RightDock",
	Size = UDim2.new(0, 178, 1, -142),
	Position = UDim2.new(1, -188, 0, 134),
	BackgroundColor3 = theme.panelDark,
	BorderSizePixel = 0,
	Parent = main,
})
...
local minimizedSize = UDim2.new(0, 840, 0, 72)
...
local function setVisible(state)
	if state then
		main.Position = UDim2.new(0.5, -420, 0.5, -250)
	end
	main.Visible = state
	if state then
		applyMinimizeState()
