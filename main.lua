--[[
	...
	MEMAYBEO HUB is a debugging suite designed to help the user debug games and find any potential vulnerabilities.
...
Main = (function()
	...
	Main.Error = function(str)
		if rconsoleprint then
			rconsoleprint("MEMAYBEO HUB ERROR: "..tostring(str).."\n")
			wait(9e9)
		else
			error(str)
		end
	...
	Main.IncompatibleTest = function()
		local function incompatibleMessage(reason)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nHello Skidsploit user,\nZinnia and the Secret Service does not approve of MEMAYBEO HUB being used on your skidsploit.\nPlease consider getting something better.\n\nIncompatible Reason: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{5,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Title",Parent={3},Position=UDim2.new(0,-190,0,15),Size=UDim2.new(0,100,0,50),Text="MEMAYBEO HUB",TextColor3=Color3.new(1,1,1),TextSize=50,TextTransparency=1,}},
	...
	Main.SetMainGuiOpen = function(val)
		...
		Main.MainGui.OpenButton.Text = val and "X" or "MEMAYBEO HUB"
